...
export class InitialSchema1783849206686 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "games" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "steamAppId" integer, "name" character varying NOT NULL, "coverUrl" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_85d9b38710a727a020efe6ac63b" UNIQUE ("steamAppId"), CONSTRAINT "PK_c9b16b62917b5595af982d66337" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."platform_connections_platform_enum" AS ENUM('STEAM')`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."platform_connections_syncstatus_enum" AS ENUM('pending', 'syncing', 'done', 'failed')`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."user_games_platform_enum" AS ENUM('STEAM')`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."user_games_status_enum" AS ENUM('FINISHED', 'PLAYING', 'BACKLOG', 'DROPPED')`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "platform_connections" ADD CONSTRAINT "FK_2fc9b5a2c5f13b761fc90abc45c" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "user_games" ADD CONSTRAINT "FK_f32a18072dfcadc634dd2fd266b" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "user_games" ADD CONSTRAINT "FK_1f35a6273ebc0cb50d852d07c5a" FOREIGN KEY ("gameId") REFERENCES "games"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "user_games" DROP CONSTRAINT "FK_1f35a6273ebc0cb50d852d07c5a"`,
        );
        await queryRunner.query(
            `ALTER TABLE "user_games" DROP CONSTRAINT "FK_f32a18072dfcadc634dd2fd266b"`,
        );
        await queryRunner.query(
            `ALTER TABLE "platform_connections" DROP CONSTRAINT "FK_2fc9b5a2c5f13b761fc90abc45c"`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `DROP TYPE "public"."platform_connections_syncstatus_enum"`,
        );
        await queryRunner.query(
